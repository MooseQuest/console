...
[![Release](https://img.shields.io/badge/release-v0.5.0-blue)](https://github.com/MooseQuest/console/releases/latest)
...
> Status: **v0.5.0**. The core engine, API, dashboard, CLI, onboarding, and an MCP server are working and tested. Interfaces may still change before v1.
