...
[![Release](https://img.shields.io/badge/release-v0.6.0-blue)](https://github.com/MooseQuest/console/releases/latest)
...
> Status: **v0.6.0**. The core engine, API, dashboard, CLI, onboarding, and an MCP server are working and tested, and Console ships as a multi-arch container image. Interfaces may still change before v1.
...
curl -sSLO https://github.com/MooseQuest/console/releases/download/v0.6.0/console_v0.6.0_darwin_arm64.tar.gz
curl -sSLO https://github.com/MooseQuest/console/releases/download/v0.6.0/SHA256SUMS.txt
shasum -a 256 -c SHA256SUMS.txt --ignore-missing   # verify integrity
tar xzf console_v0.6.0_darwin_arm64.tar.gz && cd console_v0.6.0_darwin_arm64
...
**Windows (PowerShell):** download `console_v0.6.0_windows_amd64.zip` from the release,
